            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-9">
                    ...
                    <div class="shadow-xs bg-white mb-5 p-3 rounded clearfix">
                        ...
                        <img class="thumbnail" src="<?php echo $page->profile_photo->url ?>" alt="<?php echo $form->title ?>" style="height: 150px;">
                    ...
                    <div class="row gutters-xs--xs">
                        ...
                        <?php if ($pages->get('/courses/course-list')->hasChildren("instructor=$page->id")) { ?>
                            <?php foreach ($pages->get('/courses/course-list')->children("instructor=$page->id") as  $form) { ?>
